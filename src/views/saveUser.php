<main class="content">
    ...
    renderTitle(
        ...
        'Crie e mantenha os usuários atualizados',
        'icofont-users'
    );
    ...
    <input type="hidden" name="id" value="<?= $id ?>">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="checkbox" id="is_admin" name="is_admin" class="form-control col-md-1 <?= $errors['is_admin'] ? 'is-invalid' : '' ?>"
                <?= $is_admin ? 'checked' : '' ?>>
                <div class="invalid-feedback">
                    <?= $errors['is_admin'] ?>
                </div>
        ...
        <div>
            <button class="btn btn-primary bt-lg">Salvar</button>
            <a href="/usersController.php" class="btn btn-secondary bt-lg">Cancelar</a>
        </div>
    </form>
</main>